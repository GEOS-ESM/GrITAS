DSET     ../../obs/Y%y4/M%m2/merra.mon_means_%e.%y4%m2_18z.hdf
TITLE    Gridded Monthly Time-Mean Observation (obs), Observation minu Forecast (omf) and Observation minus Analysis (oma) Values at 18 UTC
DTYPE    netcdf
OPTIONS  template
UNDEF    1e+15
