DSET     ../../obs/Y%y4/M%m2/merra.mon_means_omf.%y4%m2_%ez.hdf
TITLE    Gridded Monthly Time-Mean Observation minus Forecast (omf) Values at Specified Synoptic Times (specified by EDEF)
DTYPE    netcdf
OPTIONS  template
UNDEF    1e+15
