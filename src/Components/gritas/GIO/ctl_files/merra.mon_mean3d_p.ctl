DSET     ../../obs/Y%y4/M%m2/merra.mon_means_%e.%y4%m2.hdf
TITLE    Gridded Monthly Time-Mean Observation (obs), Observation minu Forecast (omf) and Observation minus Analysis (oma) Values at all Synoptic Times
DTYPE    netcdf
OPTIONS  template
UNDEF    1e+15
...
TDEF  12 LINEAR  12Z01JAN2000 1mo
EDEF   3  NAMES    obs omf oma
VARS 27
