...
#    set Months = ( 01 02 03 04 05 06 07 08 09 10 11 12 )
     ...
     set Months = ( 01 02 03 04 05 06 07 08 09 10 11 12 )
  else if ( $SubSetNo == 6a ) then
     set Years  = ( 1995           )
     set Months = (                            10 11 12 )
  else if ( $SubSetNo == 6b ) then
     set Years  = (      1996 1997 )
     set Months = ( 01 02 03 04 05 06 07 08 09 10 11 12 )
     ...
     set Months = ( 01 02 03 04 05 06 07 08 09 10 11 12 )
  else if ( $SubSetNo == 8a ) then
     set Years  = ( 2001           )
     set Months = (                            10 11 12 )
  else if ( $SubSetNo == 8b ) then
     set Years  = (      2002 2003 )
     set Months = ( 01 02 03 04 05 06 07 08 09 10 11 12 )
  else if ( $SubSetNo == 9 ) then
     set Years  = ( 2004 2005 2006 )
     set Months = ( 01 02 03 04 05 06 07 08 09 10 11 12 )
  else if ( $SubSetNo == 9a ) then
     set Years  = ( 2004           )
     set Months = (                            10 11 12 )
  else if ( $SubSetNo == 9b ) then
     set Years  = (      2005 2006 )
     set Months = ( 01 02 03 04 05 06 07 08 09 10 11 12 )
   else
